...
- **TWSE / TPEx 官方資料**：收盤價量、三大法人買賣超、融資融券、本益比／殖利率／淨值比、月營收、加權指數、
  外資持股比例、借券賣出餘額、除權息預告
- **公開資訊觀測站**：月營收歷史、季度損益、資產負債與現金流量（EPS、毛利率、ROE、ROA、負債比、自由現金流）、公司基本資料
- **集保中心**：股權分散表（千張大戶、散戶持股）；**期交所**：台指期三大法人未平倉
- **FinMind API**：K 線歷史、歷年股利與除權息結果
- **現股當沖**（上市櫃）、**公開申購**抽籤日程、**盤中即時報價**（證交所基本市況報導）
...
- **選股工具**：均線排列、突破新高、跳空、爆量長紅黑、相對強弱、投信認養等訊號，可加上本益比、殖利率、
  營收年增、股價區間、產業、週轉率、當沖比等條件；條件可存成範本；結果可複選並一次加入觀察名單
- **觀察名單**（選股工具內）：可建立多個名單組合，顯示價格與訊號，區分「今日新出現」與「持續中」
- **訊號回測**：訊號出現後 5／20 個交易日的報酬分布、勝率與相對大盤的超額報酬
- **個股比較**：最多 6 檔的相對走勢（起點＝100，對照加權指數）與估值、獲利、籌碼指標並排
- **市場總覽**：市場溫度計（創新高／新低家數、漲跌家數比、騰落線）、期貨三大法人未平倉、產業熱力圖、
  排行榜（漲跌幅、成交量值、週轉率、法人買賣超、殖利率、當沖比）、大盤融資融券餘額趨勢
- **個股詳情**：日K／週K／月K 與 KD／MACD／RSI、支撐壓力與成交量密集區、相對大盤強弱、公司資料、月營收、
  季度財報與財務體質（杜邦分析、現金流）、股利政策與填息、本益比／淨值比河流圖、千張大戶、外資持股與借券、現股當沖、盤中即時成交
- **條件提醒**：價格、漲跌幅、持股損益、觀察名單訊號，收集完成後跳 Windows 通知
- **行事曆**：除權息（持股附預估現金股利）、月營收公布期限、AI 預測檢驗日、公開申購（承銷價與目前股價價差）
