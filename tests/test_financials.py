...
BALANCE_HTML = """<table><tr><th>公司代號</th><th>公司名稱</th><th>歸屬於母公司業主之權益合計</th><th>權益總計</th>
<th>母公司暨子公司所持有之母公司庫藏股股數（單位：股）</th></tr>
<tr><td>2330</td><td>台積電</td><td>5,890,960,252</td><td>5,932,388,921</td><td>0</td></tr></table>"""
...
class ParseTests(unittest.TestCase):
    ...
    def test_fetch_quarter_merges_equity(self):
        pages = {"t163sb04": INCOME_HTML, "t163sb05": BALANCE_HTML}
